"""Holds useful utility functions."""


def encoded_string_to_bytes(encoded_string):
    r"""Convert an encoded string (that is represented in a non-encoded string) to bytes.
...
def bytes_to_encoded_string(bstr):
    """Perform the opposite of encoded_string_to_bytes."""
